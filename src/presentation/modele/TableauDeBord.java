...
public class TableauDeBord {
	...
	public TableauDeBord(Double maxSolde, Double minSolde, Long nombreTotaleClient, Long nombreTotaleCompte,
			String nomClientLePlusRiche, Long totalClientsFemme, Long totaleClientsHomme) {
		setMaxSolde(maxSolde);
		setMinSolde(minSolde);
		setNombreTotaleClient(nombreTotaleClient);
		setNombreTotaleCompte(nombreTotaleCompte);
		setNomClientLePlusRiche(nomClientLePlusRiche);
		setTotalClientsFemme(totalClientsFemme);
		setTotaleClientsHomme(totaleClientsHomme);
	}
